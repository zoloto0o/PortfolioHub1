        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_MediaFiles_AspNetUsers_OwnerUserId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_PortfolioItems_AspNetUsers_OwnerUserId",
                        column: x => x.OwnerUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    About = table.Column<string>(type: "TEXT", maxLength: 800, nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "TEXT", nullable: false),
                    AvatarFileId = table.Column<int>(type: "INTEGER", nullable: true),
                    CoverFileId = table.Column<int>(type: "INTEGER", nullable: true),
                    ThemeKey = table.Column<string>(type: "TEXT", maxLength: 40, nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Profiles_MediaFiles_AvatarFileId",
                        column: x => x.AvatarFileId,
                        principalTable: "MediaFiles",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.SetNull);
                    table.ForeignKey(
                        name: "FK_Profiles_MediaFiles_CoverFileId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_PortfolioMedia_MediaFiles_MediaFileId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PortfolioItems_OwnerUserId",
                table: "PortfolioItems",
                column: "OwnerUserId");

            migrationBuilder.CreateIndex(
                name: "IX_PortfolioMedia_MediaFileId",
                table: "PortfolioMedia",
                column: "MediaFileId");

            migrationBuilder.CreateIndex(
                name: "IX_PortfolioMedia_PortfolioItemId",
                table: "PortfolioMedia",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Profiles_CoverFileId",
                table: "Profiles",
                column: "CoverFileId");

            migrationBuilder.CreateIndex(
                name: "IX_Profiles_NormalizedUsername",
                table: "Profiles",
                column: "NormalizedUsername",
                unique: true);
